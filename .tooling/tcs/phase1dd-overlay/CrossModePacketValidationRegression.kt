...
object CrossModePacketValidationRegression {
    ...
    fun run(assets: File) {
        ...
        println("phase1d_d_regular_manifest_sha256=" + regularManifest.canonicalSha256())
        println("phase1d_d_letter_manifest_sha256=" + letterManifest.canonicalSha256())
        println("phase1d_d_telephone_manifest_sha256=" + telephoneManifest.canonicalSha256())
        println("phase1d_d_exact_approval_binding=PASS")
        println("phase1d_d_print_readiness=PASS")
