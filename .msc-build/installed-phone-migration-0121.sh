...
PY
printf '%s\n' 'PASS: same-signer 0.12.0 source-stage APK created a Room v6 database; same-signer 0.12.1 APK upgraded it in place to v7, launched on phone and tablet geometry, displayed the hardened AI source-protection UI, and produced no package-specific fatal exception.' | tee "$EVIDENCE/RESULT.txt"
